...
import { ScrollView,StyleSheet,View,Text,TextInput,Button,Image,KeyboardAvoidingView } from 'react-native';
      ...
      <View>
        ...
        <View style={container}>
          ...
          <View style={sendcontstyle}>
            <TextInput
              style={{height: 295, borderColor: 'gray', borderWidth: 0,fontSize: 16,backgroundColor:'red'}}
              onChangeText={(text) => this.setState({text})}
