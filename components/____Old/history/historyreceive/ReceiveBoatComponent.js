...
export class ReceiveBoatComponent extends Component {
    showBoatContent() {
...
const BoatContent = (props) => {
    ...
    return (
        <View style={contstyle}>
            {/*內文OK*/}
            <Text style={context}>{props.receiveBoatContent}</Text>
        </View>
    )
}
//船時間地點
...
export default ReceiveBoatComponent;