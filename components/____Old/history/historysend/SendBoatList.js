...
export class HistoryBoatList extends Component {
    showBoatContent() {
        this.props.navigation.navigate('HistorySendMoreScreen', { data: this.props });
    }
    render() {
        ...
        return (
            <View>
                <TouchableHighlight onPress={() => this.showBoatContent()} underlayColor={"white"}>
                    <View style={bgcolor}>
                        <NewReply {...this.props} />
                        <BoatType {...this.props} />
                        <View>
                            <BoatTitle {...this.props} />
                            <BoatContent {...this.props} />
                            <BoatLocateTime {...this.props} />
                        </View>

                        <View>
                            {/*有被回復過才出現OK*/}
                            <BoatReceiveIcon {...this.props} />
                        </View>
                    </View>
                </TouchableHighlight>
            </View>
...
export default HistoryBoatList;